...
public function store(Request $request) {
    ...
    try {
        ...
        // Logika ambil ID dan Nama
        if ($request->has('user_id')) {
            //  admin input
            $borrower = \App\Models\Borrower::findOrFail($request->user_id);
...
$data['approver_type'] = get_class($user);
$loan->update($data);
